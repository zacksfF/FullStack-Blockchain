...
// ErrNoTransaction is returned when a block is required to be created
// and there are not enough transaction.
var ErrNoTransactions = errors.New("no transaction is mempool")
