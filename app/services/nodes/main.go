...
import (
	...
	"github.com/zacksfF/FullStack-Blockchain/app/services/nodes/handlers/routers"
	...
	"github.com/zacksfF/FullStack-Blockchain/blockchain/storage/disk"
	"github.com/zacksfF/FullStack-Blockchain/blockchain/worker"
	"github.com/zacksfF/FullStack-Blockchain/events"
	"github.com/zacksfF/FullStack-Blockchain/logger"
	"github.com/zacksfF/FullStack-Blockchain/nameservices"
	"go.uber.org/zap"
)

// build is the git version  of this program, It is set using flags in the makefile
var build = "develop"
...
func main() {
	...
	//perform teh startup and shutdown sequence.
...
func run(log *zap.SugaredLogger) error {
	...
	//This is all teh configuration for the application and the default values.
	...
	fmt.Println(`     _    ____  _    _     ____  ____  _        _     ____  _    ____ _  __    _    ____ _  __ `)
	fmt.Println(`    / \  / ___|| |  | |   | __ )| __ )| |      / \   / ___|| |  | __ ) |/ /   / \  / ___| |/ / `)
	fmt.Println(`   / _ \ \___ \| |  | |   |  _ \|  _ \| |     / _ \  \___ \| |  |  _ \ ' /   / _ \| |   | ' /  `)
	fmt.Println(`  / ___ \ ___) | |__| |   | |_) | |_) | |___ / ___ \  ___) | |__| |_) | . \ / ___ \ |___| . \  `)
	fmt.Println(` /_/   \_\____/ \____/    |____/|____/|_____/_/   \_\|____/ \____|____/_|\_/_/   \_\____|_|\_\ `)
	fmt.Print("\n")
	...
	ns, err := nameservices.New(cfg.NameService.Folder)
	if err != nil {
	...
	publicMux := routers.PublicMux(routers.MuxConfig{
		Shutdown: shutdown,
		Log:      log,
		State:    state,
		NS:       ns,
	...
	privateMux := routers.PrivateMux(routers.MuxConfig{
		Shutdown: shutdown,
		Log:      log,
		State:    state,
	})
